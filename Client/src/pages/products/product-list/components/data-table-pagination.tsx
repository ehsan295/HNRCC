  ...
  return (
    <div className="flex items-center justify-between px-2">
      <div className="flex-1 text-sm text-muted-foreground">
        ...
        {table.getFilteredRowModel().rows.length} نتیجه انتخاب شده
      </div>
      <div className="flex items-center space-x-6 lg:space-x-8">
        <div className="flex items-center space-x-2 gap-3 flex-row-reverse">
          <p className="text-sm font-medium">نتیجه در هر صفحه</p>
          <Select
